...
import PdfReader from "@/components/wechat/pdfReader/index.vue";
import {getLearningCornerRobotList} from "@/apis/chat";
import LearningCornerChatRobotType0 from "@/components/wechat/learningCornerChatRobotType0/index.vue";

export default {
  name: 'LearningCornerChat',
  components: {LearningCornerChatRobotType0, PdfReader},
  data() {
    return {
      assets: {
  ...
  methods: {
    ...
    toLearningCornerBook() {
      this.$router.push("/wechat/learningCornerBook?token=" + this.token);
    },
  }
}
</script>
